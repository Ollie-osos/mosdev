  ...
  function(e) {
    ...
    console.log(
      'event.relatedTarget is ' +
        ...
        '.' +
        e.relatedTarget.className.replace(/\s/g, '.')
    );
  },
  false
);
...
var externalModalContent = {
  ...
  content:
    'This example also uses the specific modal events like <code>show.bs.modal</code>, so please open your console and check the logs. This is also a variable here, efficiently unleash cross-media information without cross-media value. Quickly maximize timely deliverables for real-time schemas. Dramatically maintain clicks-and-mortar solutions without functional solutions.',
};

// set new content for the modal and show it
btnModal2.addEventListener(
  'click',
  function() {
    //template content for modal example 2
    modalInitJS.setContent(
      '<div class="modal-header">' +
        '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>' +
        '<h4 class="modal-title" id="myModalJSLabel">' +
        externalModalContent.title +
        '</h4>' +
        '</div>' +
        '<div class="modal-body">' +
        '<p>' +
        externalModalContent.content +
        '</p>' +
        '</div>' +
        '<div class="modal-footer">' +
...
btnModalNotTrigger.addEventListener(
  'click',
  function(e) {
    e.preventDefault();
  ...
  function(e) {
    var related =
      ...
      (e.relatedTarget
        ...
        : 'null');
    console.log(
      'The "show.bs.modal" event fired for #' + e.target.id + related
    );
  },
  false
);
  ...
  function(e) {
    var related =
      ...
      (e.relatedTarget
        ...
        : 'null');
    console.log(
      'The "shown.bs.modal" event fired for #' + e.target.id + related
    );
  },
  false
);
myModalJS.addEventListener(
  'hide.bs.modal',
  function(e) {
    console.log('The "hide.bs.modal" event fired for #' + e.target.id);
  },
  false
);
myModalJS.addEventListener(
  'hidden.bs.modal',
  function(e) {
    console.log('The "hidden.bs.modal" event fired for #' + e.target.id);
  },
  false
);
...
changeModal1.addEventListener(
  'click',
  function() {
    if (!/scroll/i.test(currentStaticModalBody.innerHTML)) {
      changeModal1.className += ' hidden';
      changeModal2.className = changeModal2.className.replace(
        new RegExp('(\\s|^)hidden(\\s|$)', 'g'),
        ''
      );
...
changeModal2.addEventListener(
  'click',
  function() {
    if (/scroll/i.test(currentStaticModalBody.innerHTML)) {
      changeModal2.className += ' hidden';
      changeModal1.className = changeModal1.className.replace(
        new RegExp('(\\s|^)hidden(\\s|$)', 'g'),
        ' '
      );
      currentStaticModalBody.innerHTML =
        '<h4>This modal changed via JavaScript</h4><p>OK now this is a different content.</p>';
...
makeMeDropdown.addEventListener(
  'click',
  function(e) {
    e.preventDefault();
    ...
    if (!/\bdisabled/.test(makeMeDropdown.className)) {
      ...
      formDropdown.parentNode.addEventListener(
        'show.bs.dropdown',
        function(e) {
          var related = null;
          related =
            ...
            (e.relatedTarget
              ...
              : 'null');
          console.log(
            'The show.bs.dropdown event fired for parent of #' +
              formDropdown.id +
              related
          );
        },
        ...
        function(e) {
          ...
          related =
            ...
            (e.relatedTarget
              ...
              : 'null');
          console.log(
            'The shown.bs.dropdown event fired for parent of #' +
              formDropdown.id +
              related
          );
        },
        ...
        function(e) {
          ...
          related =
            ...
            (e.relatedTarget
              ...
              : 'null');
          console.log(
            'The hide.bs.dropdown event fired for parent of #' +
              formDropdown.id +
              related
          );
        },
        ...
        function(e) {
          ...
          related =
            ...
            (e.relatedTarget
              ...
              : 'null');
          console.log(
            'The hidden.bs.dropdown event fired for parent of #' +
              formDropdown.id +
              related
          );
        },
...
tabsToggleView.addEventListener('click', function(e) {
  ...
  if (
    e.target.tagName === 'A' &&
    e.target.getAttribute('data-nclass') !== undefined
  ) {
    tabsDemo.className = e.target.getAttribute('data-nclass');
    tabsToggleView.querySelector('button').innerHTML =
      'Viewing ' + e.target.innerHTML;
  } else {
    return false;
  }
});
...
dangerAlert.addEventListener('closed.bs.alert', function(e) {
  ...
  successAlert.innerHTML =
    "<h4>Wow you REALLY got no error!</h4><p>Javascript isn't fun? Well, think again.</p>";
  successAlert.innerHTML +=
    "<p>I just didn't want this section to be empty, looks awful..</p>";
  dangerAlert.parentNode.insertBefore(
    successAlert,
...
// NEW Alert events
document
  .getElementById('alertDemo')
  .addEventListener('close.bs.alert', function(e) {
    console.log('The "close.bs.alert" event fired for #' + e.target.id);
  });
document
  .getElementById('alertDemo')
  .addEventListener('closed.bs.alert', function(e) {
...
var someTitleFromOtherCode =
  'Popover via JavaScript <span class="label label-primary">FOCUS</span>';
var someContentFromOuterSpace =
  '<p>Some sample message from outer space wrapped in &lt;p&gt; tags. You can add your own functions to combine with Popover template as you wish.</p>';
var popover2 = new Popover('.popover-via-template', {
  trigger: 'focus',
  template:
    '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title">' +
    someTitleFromOtherCode +
    '</h3><div class="popover-content">' +
    someContentFromOuterSpace +
    '</div></div>',
});
...
var success = document.getElementById('successButton'),
  successOuter = success.outerHTML;
...
genericCarousel.addEventListener('slide.bs.carousel', function(e) {
  console.log(
    'The #' +
      e.target.id +
      ' is about to slide, and this was the "slide" event, direction: ' +
      genericCarousel.Carousel.direction +
      ', relatedTarget: ' +
      e.relatedTarget.tagName +
      '.' +
...
genericCarousel.addEventListener('slid.bs.carousel', function(e) {
  console.log(
    'The #' +
      e.target.id +
      ' has finished the slide transition, and this was the "slid" event, direction: ' +
      genericCarousel.Carousel.direction +
      ', relatedTarget: ' +
      e.relatedTarget.tagName +
      '.' +
...
mainSlider.addEventListener('slide.bs.carousel', function(e) {
  ...
  var activeCaption = mainSliderItems[currentActive].querySelector(
    '.carousel-caption'
  );
...
if (
  ...
  !/ie/.test(document.documentElement.className)
) {
  function resetNav() {
...
mainContainerSpy.addEventListener(
  ...
  function(e) {
    ...
    if (
      componentsItem === target.parentNode ||
      componentsItem.querySelector('li.active') === target.parentNode
    ) {
...
checkboxes.addEventListener('change.bs.button', function() {
  console.log('The button group with CHECKBOXES changed');
});
checkBtns[0].addEventListener('change.bs.button', function() {
  console.log(
    'Hopa! This handler is bound by the "change" of the FIRST CHECKBOX only.'
  );
});
document
  .getElementById('radioButtons')
  .addEventListener('change.bs.button', function() {
    console.log('The button group with RADIOS changed');
  });
radioBtns[0].addEventListener('change.bs.button', function() {
  console.log(
    'This handler is bound by the "change" of the FIRST RADIO button only.'
  );
});

// new Affix events, well some of them
var navScrollspy = document.getElementById('nav-scrollspy');
navScrollspy.addEventListener(
  'affix.bs.affix',
  function(e) {
    console.log('The "affix.bs.affix" event fired for #' + e.target.id);
  },
  false
);
navScrollspy.addEventListener(
  'affix-top.bs.affix',
  function(e) {
    console.log('The "affix-top.bs.affix" event fired for #' + e.target.id);
  },
  false
);
navScrollspy.addEventListener(
  ...
  function(e) {
    console.log('The "affix-bottom.bs.affix" event fired for #' + e.target.id);
  },
  false
);
...
collapseExample.addEventListener(
  'show.bs.collapse',
  function() {
    console.log('The show.bs.collapse event fired for #' + collapseExample.id);
  },
  false
);
collapseExample.addEventListener(
  'shown.bs.collapse',
  function() {
    console.log('The shown.bs.collapse event fired for #' + collapseExample.id);
  },
  false
);
collapseExample.addEventListener(
  'hide.bs.collapse',
  function() {
    console.log('The hide.bs.collapse event fired for #' + collapseExample.id);
  },
  false
);
collapseExample.addEventListener(
  ...
  function() {
    console.log(
      'The hidden.bs.collapse event fired for #' + collapseExample.id
    );
  },
  false
);
...
var scrollSpyElement = document.querySelector(
  '[data-target="#navbar-example"]'
);
scrollSpyElement.addEventListener(
  'activate.bs.scrollspy',
  function(e) {
    var related = e.relatedTarget
      ...
      : '';
    console.log(
      'The activate.bs.scrollspy event fired for div[data-target="#navbar-example"]' +
        related
    );
  },
  false
...
function setNavbarOpacity() {
  ...
  scrollTimer = !navbar.classList.contains('HOVER')
    ? setTimeout(function() {
        var scrollTop =
          window.pageYOffset || document.documentElement.scrollTop;
        if (scrollTop < 120) {
