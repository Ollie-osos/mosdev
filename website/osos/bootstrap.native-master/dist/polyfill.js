...
(function() {
  ...
  var Doc = 'Document',
    doc = document,
    DOCUMENT = this[Doc] || this.HTMLDocument, // IE8
    WIN = 'Window',
    win = window,
    WINDOW = this.constructor || this[WIN] || Window, // old Safari
  ...
  if (!win[EVENT] || !WINDOW[prototype][EVENT]) {
    win[EVENT] = WINDOW[prototype][EVENT] = DOCUMENT[prototype][
      EVENT
    ] = ELEMENT[prototype][EVENT] = function(type, eventInitDict) {
      if (!type) {
  ...
  if (!(CustomEvent in win) || !(CustomEvent in WINDOW[prototype])) {
    win[CustomEvent] = WINDOW[prototype][CustomEvent] = DOCUMENT[prototype][
      CustomEvent
    ] = Element[prototype][CustomEvent] = function(type, eventInitDict) {
      if (!type) {
  ...
  if (!win[addEventListener] || !WINDOW[prototype][addEventListener]) {
    win[addEventListener] = WINDOW[prototype][addEventListener] = DOCUMENT[
      prototype
    ][addEventListener] = ELEMENT[prototype][addEventListener] = function() {
      var element = this,
        type = arguments[0],
    ...
    win[removeEventListener] = WINDOW[prototype][
      removeEventListener
    ] = DOCUMENT[prototype][removeEventListener] = ELEMENT[prototype][
      removeEventListener
    ] = function() {
      var element = this,
        type = arguments[0],
  ...
  if (
    ...
    win[dispatchEvent] = WINDOW[prototype][dispatchEvent] = DOCUMENT[prototype][
      dispatchEvent
      ...
      try {
        ...
        do {
          ...
          if (
            IE8EVENTS in element &&
            typeof element[IE8EVENTS][type] === 'function'
          ) {
          ...
          element =
            element.nodeType === 9 ? element.parentWindow : element.parentNode;
